...
def generate_weekly_report():
    ...
    trend_icon = "<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">trending_up</span>" if trend > 0 else "<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">trending_down</span>" if trend < 0 else "➡"
...
<body>
    <div class="container">
        <div class="header">
            <h1><span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">bar_chart</span> Raport Tygodniowy</h1>
        ...
        <div class="content">
            ...
            <!-- Alert o zwrotach -->
            {f'<div class="alert"><span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">warning</span> <strong>{week_stats["zwroty"]} zwrotów</strong> w tym tygodniu</div>' if week_stats['zwroty'] > 0 else ''}
            
            <!-- TOP 5 Produktów -->
            <div class="section">
                <div class="section-title"><span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">emoji_events</span> TOP 5 Produktów</div>
                <table>
                    <tr>
            ...
            <!-- TOP Dostawcy -->
            <div class="section">
                <div class="section-title"><span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">inventory_2</span> Dostawcy</div>
                <table>
                    <tr>
                        <th>Dostawca</th>
            ...
            <!-- Podsumowanie -->
            <div class="section">
                <div class="section-title"><span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">assignment</span> Podsumowanie</div>
                <table>
                    <tr>
