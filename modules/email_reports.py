...
def generate_weekly_report():
    ...
    trend_icon = "<i class=mi>trending_up</i>" if trend > 0 else "<i class=mi>trending_down</i>" if trend < 0 else "➡"
    ...
    for i, p in enumerate(top_produkty):
        medal = "<i class=mi>emoji_events</i>" if i == 0 else "<i class=mi>emoji_events</i>" if i == 1 else "<i class=mi>emoji_events</i>" if i == 2 else f"{i+1}."
        top_produkty_html += f'''
        <tr>
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class=mi>bar_chart</i> Raport Tygodniowy</h1>
        ...
        <div class="content">
            ...
            <!-- Alert o zwrotach -->
            {f'<div class="alert"><i class=mi>warning</i> <strong>{week_stats["zwroty"]} zwrotów</strong> w tym tygodniu</div>' if week_stats['zwroty'] > 0 else ''}
            
            <!-- TOP 5 Produktów -->
            <div class="section">
                <div class="section-title"><i class=mi>emoji_events</i> TOP 5 Produktów</div>
                <table>
                    <tr>
            ...
            <!-- TOP Dostawcy -->
            <div class="section">
                <div class="section-title"><i class=mi>inventory_2</i> Dostawcy</div>
                <table>
                    <tr>
                        <th>Dostawca</th>
            ...
            <!-- Podsumowanie -->
            <div class="section">
                <div class="section-title"><i class=mi>assignment</i> Podsumowanie</div>
                <table>
                    <tr>
