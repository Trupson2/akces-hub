...
KATEGORIE_DISPLAY = {
    'ev_ladowarki': '<i class=mi>bolt</i> Ładowarki EV',
    'foto_video': '<i class=mi>photo_camera</i> Foto/Video',
    'druk3d': '<i class=mi>print</i> Druk 3D',
    'smart_home': '<i class=mi>videocam</i> Smart Home',
    'motoryzacja': '<i class=mi>directions_car</i> Motoryzacja',
    'optyka': '<i class=mi>explore</i> Optyka',
    'rolnictwo': '<i class=mi>agriculture</i> Rolnictwo',
    'dekoracje': '<i class=mi>park</i> Dekoracje',
    'oswietlenie': '<i class=mi>lightbulb</i> Oświetlenie',
    'kuchnia': '<i class=mi>restaurant</i> Kuchnia',
    'budowa': '<i class=mi>handyman</i> Budowa',
    'biuro': '<i class=mi>work</i> Biuro',
    'outdoor': '<i class=mi>hiking</i> Outdoor',
    'rehabilitacja': '<i class=mi>accessible</i> Rehabilitacja',
    'tekstylia': '<i class=mi>bed</i> Tekstylia',
    'kosmetyki': '<i class=mi>sanitizer</i> Kosmetyki',
    'ksiazki': '<i class=mi>menu_book</i> Książki',
    'prezenty': '<i class=mi>redeem</i> Prezenty',
    'bezpieczenstwo': '<i class=mi>lock</i> Bezpieczeństwo',
    'bagaz': '<i class=mi>luggage</i> Bagaż',
    'silownia': '<i class=mi>fitness_center</i> Siłownia',
    'rowery': '<i class=mi>directions_bike</i> Rowery',
    'hulajnogi': '<i class=mi>electric_scooter</i> Hulajnogi',
    'agd_male': '<i class=mi>power</i> AGD małe',
    'agd_duze': '<i class=mi>home</i> AGD duże',
    'komputery': '<i class=mi>computer</i> Komputery/IT',
    'telefony': '<i class=mi>smartphone</i> Telefony',
    'akcesoria': '<i class=mi>battery_full</i> Akcesoria',
    'rtv': '<i class=mi>tv</i> RTV/Audio',
    'gaming': '<i class=mi>sports_esports</i> Gaming',
    'narzedzia': '<i class=mi>build</i> Narzędzia',
    'dom_ogrod': '<i class=mi>cottage</i> Dom i ogród',
    'sport': '⚽ Sport/Fitness',
    'zabawki': '<i class=mi>toys</i> Zabawki',
    'moda': '<i class=mi>checkroom</i> Moda',
    'zdrowie': '<i class=mi>medication</i> Zdrowie/Uroda',
    'zwierzeta': '<i class=mi>pets</i> Zwierzęta',
    'muzyka': '<i class=mi>music_note</i> Muzyka',
    'elektronarzedzia': '<i class=mi>handyman</i> Elektronarzędzia',
    'hobby': '<i class=mi>palette</i> Hobby/Rękodzieło',
    'niemowleta': '<i class=mi>child_care</i> Niemowlęta',
    'car_audio': '<i class=mi>volume_up</i> Car Audio',
    'klimatyzacja': '<i class=mi>thermostat</i> Klimatyzacja',
    'hydroponika': '🪴 Hydroponika',
    'wedkarstwo': '<i class=mi>phishing</i> Wędkarstwo',
    'laboratorium': '<i class=mi>biotech</i> Laboratorium',
    'event': '<i class=mi>storefront</i> Event/Imprezy',
    'cb_radio': '<i class=mi>satellite_alt</i> CB/Radio',
    'elektronika': '<i class=mi>photo_camera</i> Elektronika',
    'inne': '<i class=mi>inventory_2</i> Inne'
}
