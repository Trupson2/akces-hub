...
KATEGORIE_DISPLAY = {
    'ev_ladowarki': '<span class="material-symbols-outlined">bolt</span> Ładowarki EV',
    'foto_video': '<span class="material-symbols-outlined">photo_camera</span> Foto/Video',
    'druk3d': '<span class="material-symbols-outlined">print</span> Druk 3D',
    'smart_home': '<span class="material-symbols-outlined">videocam</span> Smart Home',
    'motoryzacja': '<span class="material-symbols-outlined">directions_car</span> Motoryzacja',
    'optyka': '<span class="material-symbols-outlined">explore</span> Optyka',
    'rolnictwo': '<span class="material-symbols-outlined">agriculture</span> Rolnictwo',
    'dekoracje': '<span class="material-symbols-outlined">park</span> Dekoracje',
    'oswietlenie': '<span class="material-symbols-outlined">lightbulb</span> Oświetlenie',
    'kuchnia': '<span class="material-symbols-outlined">restaurant</span> Kuchnia',
    'budowa': '<span class="material-symbols-outlined">handyman</span> Budowa',
    'biuro': '<span class="material-symbols-outlined">work</span> Biuro',
    'outdoor': '<span class="material-symbols-outlined">hiking</span> Outdoor',
    'rehabilitacja': '<span class="material-symbols-outlined">accessible</span> Rehabilitacja',
    'tekstylia': '<span class="material-symbols-outlined">bed</span> Tekstylia',
    'kosmetyki': '<span class="material-symbols-outlined">sanitizer</span> Kosmetyki',
    'ksiazki': '<span class="material-symbols-outlined">menu_book</span> Książki',
    'prezenty': '<span class="material-symbols-outlined">redeem</span> Prezenty',
    'bezpieczenstwo': '<span class="material-symbols-outlined">lock</span> Bezpieczeństwo',
    'bagaz': '<span class="material-symbols-outlined">luggage</span> Bagaż',
    'silownia': '<span class="material-symbols-outlined">fitness_center</span> Siłownia',
    'rowery': '<span class="material-symbols-outlined">directions_bike</span> Rowery',
    'hulajnogi': '<span class="material-symbols-outlined">electric_scooter</span> Hulajnogi',
    'agd_male': '<span class="material-symbols-outlined">power</span> AGD małe',
    'agd_duze': '<span class="material-symbols-outlined">home</span> AGD duże',
    'komputery': '<span class="material-symbols-outlined">computer</span> Komputery/IT',
    'telefony': '<span class="material-symbols-outlined">smartphone</span> Telefony',
    'akcesoria': '<span class="material-symbols-outlined">battery_full</span> Akcesoria',
    'rtv': '<span class="material-symbols-outlined">tv</span> RTV/Audio',
    'gaming': '<span class="material-symbols-outlined">sports_esports</span> Gaming',
    'narzedzia': '<span class="material-symbols-outlined">build</span> Narzędzia',
    'dom_ogrod': '<span class="material-symbols-outlined">cottage</span> Dom i ogród',
    'sport': '⚽ Sport/Fitness',
    'zabawki': '<span class="material-symbols-outlined">toys</span> Zabawki',
    'moda': '<span class="material-symbols-outlined">checkroom</span> Moda',
    'zdrowie': '<span class="material-symbols-outlined">medication</span> Zdrowie/Uroda',
    'zwierzeta': '<span class="material-symbols-outlined">pets</span> Zwierzęta',
    'muzyka': '<span class="material-symbols-outlined">music_note</span> Muzyka',
    'elektronarzedzia': '<span class="material-symbols-outlined">handyman</span> Elektronarzędzia',
    'hobby': '<span class="material-symbols-outlined">palette</span> Hobby/Rękodzieło',
    'niemowleta': '<span class="material-symbols-outlined">child_care</span> Niemowlęta',
    'car_audio': '<span class="material-symbols-outlined">volume_up</span> Car Audio',
    'klimatyzacja': '<span class="material-symbols-outlined">thermostat</span> Klimatyzacja',
    'hydroponika': '🪴 Hydroponika',
    'wedkarstwo': '<span class="material-symbols-outlined">phishing</span> Wędkarstwo',
    'laboratorium': '<span class="material-symbols-outlined">biotech</span> Laboratorium',
    'event': '<span class="material-symbols-outlined">storefront</span> Event/Imprezy',
    'cb_radio': '<span class="material-symbols-outlined">satellite_alt</span> CB/Radio',
    'elektronika': '<span class="material-symbols-outlined">photo_camera</span> Elektronika',
    'inne': '<span class="material-symbols-outlined">inventory_2</span> Inne'
}
