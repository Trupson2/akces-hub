...
# UWAGA: te etykiety lecą do wielu miejsc - tabel (auto-escape Jinja),
# select option-ow (HTML stripped) oraz raw HTML wstawek. Material Symbols
# spany dzialaly tylko w tych ostatnich, w pozostalych pokazywaly "<span..>"
# jako tekst. Emoji renderuja sie wszedzie spojnie.
KATEGORIE_DISPLAY = {
