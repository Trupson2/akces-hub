...
KATEGORIE_DISPLAY = {
    'ev_ladowarki': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">bolt</span> Ładowarki EV',
    'foto_video': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">photo_camera</span> Foto/Video',
    'druk3d': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">print</span> Druk 3D',
    'smart_home': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">videocam</span> Smart Home',
    'motoryzacja': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">directions_car</span> Motoryzacja',
    'optyka': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">explore</span> Optyka',
    'rolnictwo': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">agriculture</span> Rolnictwo',
    'dekoracje': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">park</span> Dekoracje',
    'oswietlenie': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">lightbulb</span> Oświetlenie',
    'kuchnia': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">restaurant</span> Kuchnia',
    'budowa': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">handyman</span> Budowa',
    'biuro': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">work</span> Biuro',
    'outdoor': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">hiking</span> Outdoor',
    'rehabilitacja': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">accessible</span> Rehabilitacja',
    'tekstylia': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">bed</span> Tekstylia',
    'kosmetyki': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">sanitizer</span> Kosmetyki',
    'ksiazki': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">menu_book</span> Książki',
    'prezenty': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">redeem</span> Prezenty',
    'bezpieczenstwo': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">lock</span> Bezpieczeństwo',
    'bagaz': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">luggage</span> Bagaż',
    'silownia': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">fitness_center</span> Siłownia',
    'rowery': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">directions_bike</span> Rowery',
    'hulajnogi': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">electric_scooter</span> Hulajnogi',
    'agd_male': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">power</span> AGD małe',
    'agd_duze': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">home</span> AGD duże',
    'komputery': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">computer</span> Komputery/IT',
    'telefony': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">smartphone</span> Telefony',
    'akcesoria': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">battery_full</span> Akcesoria',
    'rtv': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">tv</span> RTV/Audio',
    'gaming': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">sports_esports</span> Gaming',
    'narzedzia': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">build</span> Narzędzia',
    'dom_ogrod': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">cottage</span> Dom i ogród',
    'sport': '⚽ Sport/Fitness',
    'zabawki': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">toys</span> Zabawki',
    'moda': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">checkroom</span> Moda',
    'zdrowie': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">medication</span> Zdrowie/Uroda',
    'zwierzeta': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">pets</span> Zwierzęta',
    'muzyka': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">music_note</span> Muzyka',
    'elektronarzedzia': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">handyman</span> Elektronarzędzia',
    'hobby': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">palette</span> Hobby/Rękodzieło',
    'niemowleta': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">child_care</span> Niemowlęta',
    'car_audio': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">volume_up</span> Car Audio',
    'klimatyzacja': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">thermostat</span> Klimatyzacja',
    'hydroponika': '🪴 Hydroponika',
    'wedkarstwo': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">phishing</span> Wędkarstwo',
    'laboratorium': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">biotech</span> Laboratorium',
    'event': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">storefront</span> Event/Imprezy',
    'cb_radio': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">satellite_alt</span> CB/Radio',
    'elektronika': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">photo_camera</span> Elektronika',
    'inne': '<span class="material-symbols-outlined" style="font-size:inherit;vertical-align:middle">inventory_2</span> Inne'
}
